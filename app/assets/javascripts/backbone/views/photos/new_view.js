...
(function() {
  ...
  Bumpyride.Views.Photos.NewView = (function(_super) {

    __extends(NewView, _super);

    NewView.prototype.template = JST["backbone/templates/photos/new"];
...
class Bumpyride.Views.Photos.NewView extends Backbone.View
